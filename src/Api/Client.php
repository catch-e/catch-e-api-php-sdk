...
class Client extends BaseClient
{
	 ...
	 * @return mixed
	 */
	public function executeEndpointWithAdditionalHeaders(\Jane\OpenApiRuntime\Client\Endpoint $endpoint, array $additionalHeaders = [], string $fetch = self::FETCH_OBJECT)
	{
	 ...
	 */
	public function printReportQuery(string $reportQueryId, \stdClass $queryParameters, string $responseContentType = 'application/json', string $fetch = self::FETCH_OBJECT)
	{
