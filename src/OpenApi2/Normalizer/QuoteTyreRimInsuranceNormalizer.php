...
class QuoteTyreRimInsuranceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'CatchE\\OpenApi2\\Model\\QuoteTyreRimInsurance' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'CatchE\\OpenApi2\\Model\\QuoteTyreRimInsurance' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \CatchE\OpenApi2\Model\QuoteTyreRimInsurance();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('tyre_rim_insurance_plan_id', $data) && null !== $data['tyre_rim_insurance_plan_id']) {
            $object->setTyreRimInsurancePlanId($data['tyre_rim_insurance_plan_id']);
        } elseif (\array_key_exists('tyre_rim_insurance_plan_id', $data) && null === $data['tyre_rim_insurance_plan_id']) {
            $object->setTyreRimInsurancePlanId(null);
        }
    ...
    {
        $data = [];
        $data['tyre_rim_insurance_plan_id'] = $object->getTyreRimInsurancePlanId();
