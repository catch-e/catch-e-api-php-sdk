...
class PackageItemDeductionPerPayGetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'CatchE\\OpenApi2\\Model\\PackageItemDeductionPerPayGet' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'CatchE\\OpenApi2\\Model\\PackageItemDeductionPerPayGet' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \CatchE\OpenApi2\Model\PackageItemDeductionPerPayGet();
