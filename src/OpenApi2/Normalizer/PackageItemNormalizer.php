...
class PackageItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('add_gst_flag', $data) && null !== $data['add_gst_flag']) {
            $object->setAddGstFlag($data['add_gst_flag']);
        } elseif (\array_key_exists('add_gst_flag', $data) && null === $data['add_gst_flag']) {
            $object->setAddGstFlag(null);
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getAddGstFlag()) {
            $data['add_gst_flag'] = $object->getAddGstFlag();
        }
