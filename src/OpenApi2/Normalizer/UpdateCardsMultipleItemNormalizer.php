...
class UpdateCardsMultipleItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'CatchE\\OpenApi2\\Model\\UpdateCardsMultipleItem' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'CatchE\\OpenApi2\\Model\\UpdateCardsMultipleItem' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \CatchE\OpenApi2\Model\UpdateCardsMultipleItem();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('card_id', $data) && null !== $data['card_id']) {
            $object->setCardId($data['card_id']);
        } elseif (\array_key_exists('card_id', $data) && null === $data['card_id']) {
