...
class CreateDriverNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'CatchE\\OpenApi2\\Model\\CreateDriver' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'CatchE\\OpenApi2\\Model\\CreateDriver' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \CatchE\OpenApi2\Model\CreateDriver();
        ...
        if (\array_key_exists('addresses', $data) && null !== $data['addresses']) {
            $object->setAddresses($this->denormalizer->denormalize($data['addresses'], 'CatchE\\OpenApi2\\Model\\CreateDriverAddresses', 'json', $context));
