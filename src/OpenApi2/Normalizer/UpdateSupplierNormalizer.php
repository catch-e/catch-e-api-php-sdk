...
class UpdateSupplierNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
	...
	{
		return 'CatchE\\OpenApi2\\Model\\UpdateSupplier' === $type;
	}

	public function supportsNormalization($data, $format = null)
	{
		return is_object($data) && 'CatchE\\OpenApi2\\Model\\UpdateSupplier' === get_class($data);
	}
	...
	public function denormalize($data, $class, $format = null, array $context = [])
	{
		...
		$object = new \CatchE\OpenApi2\Model\UpdateSupplier();
		...
		if (\array_key_exists('financier', $data) && null !== $data['financier']) {
			$object->setFinancier($this->denormalizer->denormalize($data['financier'], 'CatchE\\OpenApi2\\Model\\UpdateSupplierFinancier', 'json', $context));
