...
class CreateSupplierNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'CatchE\\OpenApi2\\Model\\CreateSupplier' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'CatchE\\OpenApi2\\Model\\CreateSupplier' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \CatchE\OpenApi2\Model\CreateSupplier();
        ...
        if (\array_key_exists('financier', $data) && null !== $data['financier']) {
            $object->setFinancier($this->denormalizer->denormalize($data['financier'], 'CatchE\\OpenApi2\\Model\\CreateSupplierFinancier', 'json', $context));
        } elseif (\array_key_exists('financier', $data) && null === $data['financier']) {
            $object->setFinancier(null);
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getFinancier()) {
            $data['financier'] = $this->normalizer->normalize($object->getFinancier(), 'json', $context);
        }
