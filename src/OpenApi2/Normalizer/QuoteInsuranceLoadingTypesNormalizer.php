...
class QuoteInsuranceLoadingTypesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'CatchE\\OpenApi2\\Model\\QuoteInsuranceLoadingTypes' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'CatchE\\OpenApi2\\Model\\QuoteInsuranceLoadingTypes' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \CatchE\OpenApi2\Model\QuoteInsuranceLoadingTypes();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('past_claims', $data) && null !== $data['past_claims']) {
            $object->setPastClaims($this->denormalizer->denormalize($data['past_claims'], 'CatchE\\OpenApi2\\Model\\QuoteInsuranceLoadingType', 'json', $context));
        ...
        if (\array_key_exists('licence', $data) && null !== $data['licence']) {
            $object->setLicence($this->denormalizer->denormalize($data['licence'], 'CatchE\\OpenApi2\\Model\\QuoteInsuranceLoadingType', 'json', $context));
        ...
        if (\array_key_exists('driver_restriction', $data) && null !== $data['driver_restriction']) {
            $object->setDriverRestriction($this->denormalizer->denormalize($data['driver_restriction'], 'CatchE\\OpenApi2\\Model\\QuoteInsuranceLoadingType', 'json', $context));
