...
class UpdateEmployeePackageItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
	...
	{
		return 'CatchE\\OpenApi2\\Model\\UpdateEmployeePackageItem' === $type;
	}

	public function supportsNormalization($data, $format = null)
	{
		return is_object($data) && 'CatchE\\OpenApi2\\Model\\UpdateEmployeePackageItem' === get_class($data);
	}
	...
	public function denormalize($data, $class, $format = null, array $context = [])
	{
		...
		$object = new \CatchE\OpenApi2\Model\UpdateEmployeePackageItem();
		...
		if (\array_key_exists('allow_retrospective_payroll_dates_flag', $data) && null !== $data['allow_retrospective_payroll_dates_flag']) {
			$object->setAllowRetrospectivePayrollDatesFlag($data['allow_retrospective_payroll_dates_flag']);
		} elseif (\array_key_exists('allow_retrospective_payroll_dates_flag', $data) && null === $data['allow_retrospective_payroll_dates_flag']) {
			$object->setAllowRetrospectivePayrollDatesFlag(null);
		}
	...
	public function normalize($object, $format = null, array $context = [])
	{
		...
		if (null !== $object->getDisbursementType()) {
		...
		if (null !== $object->getAllowRetrospectivePayrollDatesFlag()) {
			$data['allow_retrospective_payroll_dates_flag'] = $object->getAllowRetrospectivePayrollDatesFlag();
		}
