...
class EmployeePackageItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
	...
	{
		return 'CatchE\\OpenApi2\\Model\\EmployeePackageItem' === $type;
	}

	public function supportsNormalization($data, $format = null)
	{
		return is_object($data) && 'CatchE\\OpenApi2\\Model\\EmployeePackageItem' === get_class($data);
	}
	...
	public function denormalize($data, $class, $format = null, array $context = [])
	{
		...
		$object = new \CatchE\OpenApi2\Model\EmployeePackageItem();
		if (\array_key_exists('employee_package_item_id', $data) && null !== $data['employee_package_item_id']) {
			$object->setEmployeePackageItemId($data['employee_package_item_id']);
		} elseif (\array_key_exists('employee_package_item_id', $data) && null === $data['employee_package_item_id']) {
			$object->setEmployeePackageItemId(null);
		}
		...
		if (\array_key_exists('_embedded', $data) && null !== $data['_embedded']) {
			$object->setEmbedded($this->denormalizer->denormalize($data['_embedded'], 'CatchE\\OpenApi2\\Model\\EmployeePackageItemEmbedded', 'json', $context));
	...
	{
		$data = [];
		if (null !== $object->getEmployeePackageItemId()) {
			$data['employee_package_item_id'] = $object->getEmployeePackageItemId();
		}
