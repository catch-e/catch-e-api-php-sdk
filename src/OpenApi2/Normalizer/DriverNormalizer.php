...
class DriverNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'CatchE\\OpenApi2\\Model\\Driver' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'CatchE\\OpenApi2\\Model\\Driver' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \CatchE\OpenApi2\Model\Driver();
        ...
        if (\array_key_exists('addresses', $data) && null !== $data['addresses']) {
            $object->setAddresses($this->denormalizer->denormalize($data['addresses'], 'CatchE\\OpenApi2\\Model\\DriverAddresses', 'json', $context));
        ...
        if (\array_key_exists('user_id_edit', $data) && null !== $data['user_id_edit']) {
            $object->setUserIdEdit($data['user_id_edit']);
        } elseif (\array_key_exists('user_id_edit', $data) && null === $data['user_id_edit']) {
            $object->setUserIdEdit(null);
        }
        if (\array_key_exists('user_id_last_edit', $data) && null !== $data['user_id_last_edit']) {
            $object->setUserIdLastEdit($data['user_id_last_edit']);
        } elseif (\array_key_exists('user_id_last_edit', $data) && null === $data['user_id_last_edit']) {
            $object->setUserIdLastEdit(null);
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getUserIdEdit()) {
            $data['user_id_edit'] = $object->getUserIdEdit();
        }
        if (null !== $object->getUserIdLastEdit()) {
            $data['user_id_last_edit'] = $object->getUserIdLastEdit();
        }
