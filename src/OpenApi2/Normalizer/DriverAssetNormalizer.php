...
class DriverAssetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
	...
	{
		return 'CatchE\\OpenApi2\\Model\\DriverAsset' === $type;
	}

	public function supportsNormalization($data, $format = null)
	{
		return is_object($data) && 'CatchE\\OpenApi2\\Model\\DriverAsset' === get_class($data);
	}
	...
	public function denormalize($data, $class, $format = null, array $context = [])
	{
		...
		$object = new \CatchE\OpenApi2\Model\DriverAsset();
		...
		if (\array_key_exists('ownership', $data) && null !== $data['ownership']) {
			$object->setOwnership($data['ownership']);
		} elseif (\array_key_exists('ownership', $data) && null === $data['ownership']) {
		...
		if (\array_key_exists('finance_asset_type_name', $data) && null !== $data['finance_asset_type_name']) {
			$object->setFinanceAssetTypeName($data['finance_asset_type_name']);
		} elseif (\array_key_exists('finance_asset_type_name', $data) && null === $data['finance_asset_type_name']) {
			$object->setFinanceAssetTypeName(null);
		}
	...
	public function normalize($object, $format = null, array $context = [])
	{
		...
		if (null !== $object->getFinanceAssetTypeName()) {
			$data['finance_asset_type_name'] = $object->getFinanceAssetTypeName();
		}
