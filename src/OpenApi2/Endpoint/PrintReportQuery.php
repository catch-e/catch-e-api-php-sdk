...
class PrintReportQuery extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Endpoint
{
	 ...
	 */
	public function __construct(string $reportQueryId, \stdClass $queryParameters)
	{
