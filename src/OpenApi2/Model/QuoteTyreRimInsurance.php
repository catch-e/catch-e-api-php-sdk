...
class QuoteTyreRimInsurance
{
    /**
     * @var null|string
     */
    protected $tyreRimInsurancePlanId;
    /**
     * @var null|float
     */
    ...
    public function getTyreRimInsurancePlanId(): ?string
    {
        return $this->tyreRimInsurancePlanId;
    }

    public function setTyreRimInsurancePlanId(?string $tyreRimInsurancePlanId): self
    {
        $this->tyreRimInsurancePlanId = $tyreRimInsurancePlanId;
