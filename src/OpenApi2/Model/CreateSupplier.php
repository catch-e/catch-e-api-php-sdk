...
class CreateSupplier
{
	...
	protected $fax;
	/**
	 * @var CreateSupplierFinancier|null
	 */
	protected $financier;
	/**
	 * @var string|null
	...
	public function getFinancier(): ?CreateSupplierFinancier
	{
		return $this->financier;
	}

	public function setFinancier(?CreateSupplierFinancier $financier): self
	{
