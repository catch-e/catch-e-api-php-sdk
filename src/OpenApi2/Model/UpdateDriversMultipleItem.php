...
class UpdateDriversMultipleItem
{
    /**
     * @var null|string
     */
    ...
    /**
     * @var null|UpdateDriversMultipleItemAddresses
     */
    protected $addresses;
    /**
     * Do not specify this value if you provide an addresses property.
     *
     * @var null|string
     */
    ...
    public function getAddresses(): ?UpdateDriversMultipleItemAddresses
    {
        return $this->addresses;
    }

    public function setAddresses(?UpdateDriversMultipleItemAddresses $addresses): self
    {
