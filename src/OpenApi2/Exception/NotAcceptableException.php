...
{
    /**
     * @var \CatchE\OpenApi2\Model\NotAcceptable
     */
    protected $notAcceptable;

    public function __construct(string $message, \CatchE\OpenApi2\Model\NotAcceptable $notAcceptable)
    {
        parent::__construct($message, 406);
        $this->notAcceptable = $notAcceptable;
    }

    public function getNotAcceptable(): \CatchE\OpenApi2\Model\NotAcceptable
    {
